...
from . import edit_or_reply, jakootelbot


@jakootelbot.ar_cmd(pattern="افكر$")
async def _(event):
...
@jakootelbot.ar_cmd(pattern="متت$")
async def _(event):
...
@jakootelbot.ar_cmd(pattern="ضايج$")
async def _(event):
...
@jakootelbot.ar_cmd(pattern="ساعه$")
async def _(event):
...
@jakootelbot.ar_cmd(pattern="قلب$")
async def _(event):
...
@jakootelbot.ar_cmd(pattern="جيم$")
async def _(event):
...
@jakootelbot.ar_cmd(pattern="الارض$")
async def _(event):
...
@jakootelbot.ar_cmd(pattern="قمر$")
async def _(event):
...
@jakootelbot.ar_cmd(pattern="اقمار$")
async def _(event):
...
@jakootelbot.ar_cmd(pattern="قمور$")
async def _(event):
