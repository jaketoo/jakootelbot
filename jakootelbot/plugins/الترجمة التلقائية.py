...
@jakootelbot.ar_cmd(pattern="تفعيل الترجمة")
...
@jakootelbot.ar_cmd(pattern="تعطيل الترجمة")
...
@jakootelbot.on(events.NewMessage(outgoing=True))
    ...
    if gvarstatus("translateen"):
        ...
        try:
            ...
            if translation.text != event.message.message:
                await jakootelbot.edit_message(event.message, translation.text)
        except:
            pass
