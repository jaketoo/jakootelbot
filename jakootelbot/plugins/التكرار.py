...
@jakootelbot.ar_cmd(pattern="كرر ([\s\S]*)")
...
@jakootelbot.ar_cmd(pattern="spspam$")
...
@jakootelbot.ar_cmd(pattern="سبام (.*)")
...
@jakootelbot.ar_cmd(pattern="وسبام (.*)")
async def tmeme(event):
...
@jakootelbot.ar_cmd(pattern=f"{TKRAR} (.*)")
async def spammer(event):
    reply = await event.get_reply_message()
...
@jakootelbot.ar_cmd(pattern="تعبير مكرر$")
...
@jakootelbot.ar_cmd(pattern="ايقاف التكرار ?(.*)")
