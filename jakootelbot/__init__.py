...
from .core.session import jakootelbot, tgbot
...
__author__ = "سورس جاكو <https://github.com/jaketoo/jakootelbot0>"
__copyright__ = f" حقوق سورس جاكو (C) 2020 - 2022  {__author__}"

jakootelbot.version = __version__
jakootelbot.tgbot.version = __version__
...
def close_connection(*_):
    ...
    runasync(jakootelbot.disconnect())
    sys.exit(143)
