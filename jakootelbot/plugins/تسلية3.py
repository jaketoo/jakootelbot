...
from . import edit_delete, edit_or_reply, jakootelbot, mention
...
async def _(event):
    ...
    animation_chars = [
        ...
        "**Starting process with command** `python3 -m jakootelbot`",
        "**State changed from starting to up**",
        "__INFO:jakootelbot:Logged in as 557667062__",
        "__INFO:jakootelbot:Successfully loaded all plugins__",
        "**Build Succeeded**",
    ]
...
@jakootelbot.on(admin_cmd(pattern="احبك"))
async def rz(jakootelbot):
    roz = random.choice(love)
    return await edit_or_reply(jakootelbot, roz)
