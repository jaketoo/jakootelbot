...
@jakootelbot.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}ترامب <text>",
        "examples": "{tr}trump  is One of the Popular jakootelbot",
    },
)
...
@jakootelbot.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}غير عقلي Catjakootelbot is One of the Popular jakootelbot",
    },
)
async def nekobot(cat):
    text = cat.pattern_match.group(1)
...
@jakootelbot.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}كانا text",
        "examples": "{tr}kanna  is One of the Popular jakootelbot",
    },
)
async def nekobot(cat):
...
@jakootelbot.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}tweet iamsrk ; is One of the Popular jakootelbot",
    },
)
async def nekobot(cat):
