    ...
    def ar_cmd(
        ...
        **kwargs,
        ...
        def decorator(func):  # sourcery no-metrics
            ...
            from .session import jakootelbot
            ...
            if pattern is not None:
                ...
                if edited:
                    jakootelbot.add_event_handler(func, events.MessageEdited(**kwargs))
                jakootelbot.add_event_handler(func, events.NewMessage(**kwargs))
            return wrapper
    ...
    def bot_cmd(
        ...
        **kwargs,
        ...
        def decorator(func):
            ...
            if edited is True:
                jakootelbot.tgbot.add_event_handler(func, events.MessageEdited(**kwargs))
            else:
                jakootelbot.tgbot.add_event_handler(func, events.NewMessage(**kwargs))
