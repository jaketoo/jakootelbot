...
from . import edit_delete, edit_or_reply, jakootelbot, progress
...
@jakootelbot.ar_cmd(pattern="زايب(?:\s|$)([\s\S]*)")
...
@jakootelbot.ar_cmd(pattern="تار(?:\s|$)([\s\S]*)")
...
@jakootelbot.ar_cmd(pattern="ان زايب(?:\s|$)([\s\S]*)")
async def zip_file(event):
...
@jakootelbot.ar_cmd(pattern="ان تار(?:\s|$)([\s\S]*)")
