...
@jakootelbot.ar_cmd(pattern="صور(?: |$)(\d*)? ?([\s\S]*)")
async def img_sampler(event):
    ...
    jakootelbot = await edit_or_reply(event, "**❃ يتم البحث انتظر قليلا**")
    ...
    try:
        ...
        return await jakootelbot.edit(f"Error: \n`{e}`")
