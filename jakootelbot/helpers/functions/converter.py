...
from jakootelbot.helpers.functions.vidtools import take_screen_shot
from jakootelbot.helpers.tools import fileinfo, media_type, meme_type
from jakootelbot.helpers.utils.utils import runcmd
