...
@jakootelbot.ar_cmd(incoming=True)
...
@jakootelbot.ar_cmd(pattern="كتم(?:\s|$)([\s\S]*)")
...
@jakootelbot.ar_cmd(pattern="الغاء كتم(?:\s|$)([\s\S]*)")
...
@jakootelbot.ar_cmd(pattern="الغاء تثبيت( الكل|$)")
